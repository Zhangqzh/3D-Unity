...
public class UserGUI : MonoBehaviour
{
    ...
    void Start() {
        ...
        countDownStyle.normal.textColor = Color.gray;
        finishStyle = new GUIStyle();
        finishStyle.fontSize = 40;
        finishStyle.normal.textColor = Color.gray;
    }
    ...
    private void OnGUI() {
        ...
        GUI.Label(new Rect(Screen.width / 2 - 80 , Screen.height / 2 - 330, 100, 50),
            "Score: " + controller.GetScore().ToString(), scoreStyle);
        GUI.Label(new Rect(Screen.width / 2 - 50, Screen.height / 2 - 290, 100, 50),
